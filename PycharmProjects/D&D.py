...
def descSubClassElfo():
    descSubClassElfo=['2,1 Alto Elfo', '2,2 Elfo Silvestre', '2,3 Drow']
    for i in range(len(descRaca)):
        print(i+1, descRaca[i])

def descSubClassAnao():
    descSubClassAnao=['3,1 Anao da colina', '3,2 Anao da montanha']
    for i in range(len(descRaca)):
        print(i+1, descRaca[i])

def descSubClassHalfling():
    descSubClassHalfling=['4,1 Pes-Ligeiros', '4,2 Robusto']
    for i in range(len(descRaca)):
        print(i+1, descRaca[i])

def descSubClassGnomo():
    descSubClassGnomo=['6,1 Gnomo dos Bosques', '6,2 Gnomo das Rochas']
    for i in range(len(descRaca)):
        print(i+1, descRaca[i])
...
if num == '1':
    ...
    print("3,1 Anao da colina 3,2 Anao da montanha")
    if(subRaca == '3,1'):
    ...
    print("4,1 Pes-Ligeiros 4,2 Robusto")
    if(subRaca == '4,1'):
    ...
    print("6,1 Gnomo dos Bosques 6,2 Gnomo das Rochas")
    if(subRaca =='6,1'):
